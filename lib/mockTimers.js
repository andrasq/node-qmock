...
module.exports = {
    // public api
    mockTimers: function mockTimers() { return overrideTimers(new MockTimers()) },
    unmockTimers: function unmockTimers() { restoreTimers() },
    ...
    if (this.timeouts[timestamp]) {
        ...
        for (var i=0; i<timeouts.length; i++) {
            ...
            if (err) {
                ...
                var newTimeouts = this.timeouts[timestamp] || [];
