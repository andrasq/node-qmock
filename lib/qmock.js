...
function getMockSkipConstructor( constructor, methods ) {
    if (typeof constructor !== 'function') {
        ...
        for (i in constructor.prototype) {
            ...
            actual[i] = constructor.prototype[i];
        }
...
function extendWithMocks( tester, doneMethod ) {
    ...
    // also the new 0.3.0 qmock methods
    tester.stub = module.exports.stub;
    tester.spy = module.exports.spy;
    tester.mockTimers = module.exports.mockTimers;
    tester.unmockTimers = module.exports.unmockTimers;
    tester.mockHttp = module.exports.mockHttp;
    tester.unmockHttp = module.exports.unmockHttp;
