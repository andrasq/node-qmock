...
Last error generated by the stub function, `null` if none.
...
Return the array of arrays of arguments passed to every call to this stub.

#### stub.getAllResults

Return the array of values returned by all calls to the stub function.

#### stub.getAllErrors

Return the array of errors thrown by all calls to the stub function.  If no error
was thrown, the array contains `null` for that call.
